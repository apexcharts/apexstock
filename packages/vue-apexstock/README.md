...
repo root, along with its ApexCharts peer, so build both first and serve over a
static server (no bundler needed):
...
# http://localhost:8080/packages/vue-apexstock/demo/
```
